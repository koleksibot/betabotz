...
const daftar3 = [{buttonId: `${prefix}verify`,buttonText: {displayText: `🔽 VEFIKASI 🔽`,},type: 1,},]
...
for (let _ of anu100) {
Ryuu.sendMessage(_.jid, bc100, image, {quoted: ftrol, caption: `*「 TESTING BOT BARU 」*\n\n${body.slice(4)}`})
}
reply('Suksess broadcast')
} else {
for (let _ of anu100) {
Ryuu.sendMessage(_.jid, 
{"contentText": `*「 Koleksibot 」*\n\n${body.slice(4)}`,
